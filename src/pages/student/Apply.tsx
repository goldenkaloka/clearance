...
export default function StudentApply() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      if (data) {
        const request = data as ExistingRequest
        ...
        if (request.status === 'payment_pending') {
          ...
          if (payment?.status === 'paid') {
            ...
            setNotice(
              'A payment is already pending. Check your phone and complete the payment.',
            )
  ...
  async function pay() {
    ...
    if (
      ...
      setNotice(
        'Sandbox mode: the payment request was created successfully.',
      )
    } else {
          ...
          {stage === 'form' ? (
            <Card>
              <div className="mb-4 flex items-start gap-2 rounded-xl bg-brand-50 p-3 text-xs leading-relaxed text-brand-800">
                ...
                <p>
                  This is a{' '}
                  <b>private assistance service</b>.
                  We are not affiliated with Ardhi
                  University, and final clearance approval
                  rests with the university offices.
                </p>
              </div>
              ...
              {paymentStatus === 'paid' ? (
                <div className="rounded-xl bg-emerald-50 p-4 text-center">
                  ...
                  <p className="mt-1 text-sm text-emerald-700">
                    Your clearance request has been
                    activated.
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-slate-400">
                    {paymentStatus === 'pending'
                      ? 'A payment request has been sent. Check your phone and complete the mobile-money prompt. This page will update automatically when payment is confirmed.'
                      : 'You will receive a mobile-money prompt on the number above. Confirm it to complete payment.'}
                  </p>
                </div>
              )}
            </Card>
        ...
        <div className="space-y-4">
          <Card className="!border-0 bg-black text-[#f8f8f8]">
            ...
            <p className="mt-3 text-xs leading-relaxed text-[#b4b4b4]">
              One-time fee for the full clearance
              assistance, paid once by mobile money.
            </p>
          </Card>
          ...
          <Card className="bg-slate-50">
            <p className="text-xs leading-relaxed text-slate-500">
              What happens next? After payment is
              confirmed, an agent is assigned and your
              clearance stages begin. You'll get notified
              at every step.
            </p>
          </Card>
        </div>
